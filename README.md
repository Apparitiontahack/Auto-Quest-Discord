...
[2/4] Configuring Rich Presence settings...
[3/4] Initializing game detection engine...
[4/4] Ready. Start completing quests.
```

### Step 4: Start Using the Tool
- Open the app from the installed directory.
- Select a verified game from the list.
- Click "Play" to start the quest timer.
...
You can follow the [development setup instructions](#-development-setup) to build the app from source, or use the Quick Install method above.
